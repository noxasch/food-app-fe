...
const FoodModal = forwardRef(function FoodModal(props, ref) {
  // const target = useRef(null);
  // const modal = new Modal($targetEl, options, instanceOptions)

  // const ref = useRef(null); //for functional component we need to use useRef

  // const SomeComponent = forwardRef(refModal)
  const modalOptions = {
